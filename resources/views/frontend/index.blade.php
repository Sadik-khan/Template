@extends('frontend.layouts.main', ['title' => 'Dahsboard', 'modal' => false])
...
<div class="main" id="main">
                        ...
                        <div class="row">
                            <div class="col-sm-4 wow fadeInUp" data-wow-delay="0.2s">
                                <div class="services-icon">
                                    <img src="{{ asset('assets/frontend/logos/icon1.png') }}" height="60" width="60" alt="Service">
                                </div>
                            ...
                            <div class="col-sm-4 wow fadeInUp" data-wow-delay="0.3s">
                                <div class="services-icon">
                                    <img class="icon-2" src="{{ asset('assets/frontend/logos/icon2.png') }}" height="60" width="60" alt="Service">
                                </div>
                                <div class="services-description">
                            ...
                            <div class="col-sm-4 wow fadeInUp" data-wow-delay="0.4s">
                                <div class="services-icon">
                                    <img class="icon-3" src="{{ asset('assets/frontend/logos/icon3.png') }}" height="60" width="60" alt="Service">
                                </div>
                                <div class="services-description">
            ...
            <div class="flex-split">
                <div class="f-left wow fadeInUp" data-wow-delay="0s">
                    <div class="left-content">
                        <img class="img-fluid" src="{{ asset('assets/frontend/images/feature_1.png') }}" alt="">
                    </div>
                </div>
            ...
            <div class="flex-split">
                ...
                <div class="f-left">
                    <div class="left-content wow fadeInUp" data-wow-delay="0.3s">
                        <img class="img-fluid" src="{{ asset('assets/frontend/images/feature_2.png') }}" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row text-center">
                <div class="col-md-12">
                    <div class="testimonials owl-carousel owl-theme">
                        <div class="testimonial-single"><img class="img-circle" src="assets\images\testimonial2.jpg" alt="Client Testimonoal">
                        ...
                        <div class="testimonial-single"><img class="img-circle" src="assets\images\testimonial1.jpg" alt="Client Testimonoal">
                        ...
                        <div class="testimonial-single"><img class="img-circle" src="assets\images\testimonial3.jpg" alt="Client Testimonoal">
                            <div class="testimonial-text">
    ...
    <div class="feature_huge text-center">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <img class="img-fluid wow fadeInUp" data-wow-delay="0.1s" src="{{ asset('assets/frontend/images/big_feature.png') }}" alt="" style="max-width:100%">
                </div>
                <div class="col-md-12 feature_list">
                    <div class="row">
                        <div class="col-sm-4 wow fadeInUp" data-wow-delay="0.2s">
                            <img src="{{ asset('assets/frontend/logos/feature_icon.png') }}" alt="Feature">
                        ...
                        <div class="col-sm-4 wow fadeInUp" data-wow-delay="0.4s">
                            <img src="{{ asset('assets/frontend/logos/feature_icon_2.png') }}" alt="Feature">
                        ...
                        <div class="col-sm-4 wow fadeInUp" data-wow-delay="0.6s">
                            <img src="{{ asset('assets/frontend/logos/feature_icon_3.png') }}" alt="Feature">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="table-left wow fadeInUp" data-wow-delay="0.4s">
                                <div class="icon">
                                    <img src="{{ asset('assets/frontend/logos/cart2.png') }}" alt="Icon">
                                </div>
                        ...
                        <div class="col-sm-6 ">
                            <div class="table-right wow fadeInUp" data-wow-delay="0.6s">
                                <div class="icon">
                                    <img src="{{ asset('assets\logos\cart1.png') }}" alt="Icon">
                                </div>
                                <div class="pricing-details">
                                    <h2>Premium Plan</h2>
                                    <span>$19.99</span>
    ...
    <div class="client-section">
        <div class="container text-center">
            <div class="clients owl-carousel owl-theme">
                <div class="single">
                    <img src="{{ asset('assets/frontend/logos/logo1.png') }}" alt="">
                </div>
                <div class="single">
                    <img src="{{ asset('assets/frontend/logos/logo2.png') }}" alt="">
                </div>
                <div class="single">
                    <img src="{{ asset('assets/frontend/logos/logo3.png') }}" alt="">
                </div>
                <div class="single">
                    <img src="{{ asset('assets/frontend/logos/logo4.png') }}" alt="">
                </div>
                <div class="single">
                    <img src="{{ asset('assets/frontend/logos/logo6.png') }}" alt="">
                </div>
                <div class="single">
                    <img src="{{ asset('assets/frontend/logos/logo7.png') }}" alt="">
                </div>
            </div>
        </div>
    </div>
